...
<head>
    ...
    <title>Coverage for env/lib/python2.7/site-packages/pymongo/monotonic.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>env/lib/python2.7/site-packages/pymongo/monotonic.py</b> :
...
<p id="t28" class="pln">&nbsp; &nbsp; <span class="com"># Monotime or Python 3.3+.</span><span class="strut">&nbsp;</span></p>
<p id="t29" class="stm run hide_run">&nbsp; &nbsp; <span class="key">from</span> <span class="nam">time</span> <span class="key">import</span> <span class="nam">monotonic</span> <span class="key">as</span> <span class="nam">time</span><span class="strut">&nbsp;</span></p>
...
<p id="t31" class="pln">&nbsp; &nbsp; <span class="com"># Not monotonic.</span><span class="strut">&nbsp;</span></p>
<p id="t32" class="stm run hide_run">&nbsp; &nbsp; <span class="key">from</span> <span class="nam">time</span> <span class="key">import</span> <span class="nam">time</span><span class="strut">&nbsp;</span></p>
